...
var mdHispanicData = {
    district: "Maryland",
    "race-dropdown": "Hispanic",
    "exposure-white": 25,
    "white-dif": -16,
    "exposure-black": 31,
    "black-dif": -4,
    "exposure-hispanic": 32,
    "hispanic-dif": 18,
    "exposure-asian": 7,
    "asian-dif": 1,
    "exposure-other": 4,
...
var mdAllPovertyData = {
    district: "Maryland",
    "poverty-dropdown": "All",
    "exposure-reduced": 44,
    "reduced-dif": null,
    "exposure-non-reduced": 56,
    "non-reduced-dif": null
};

var mdReducedPovertyData = {
    district: "Maryland",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 61,
    "reduced-dif": 17,
    "exposure-non-reduced": 31,
    "non-reduced-dif": -25
};

var mdNonReducedPovertyData = {
    district: "Maryland",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 39,
    "reduced-dif": -5,
    "exposure-non-reduced": 69,
    "non-reduced-dif": 13
};

var howardAllPovertyData = {
    district: "Howard County",
    "poverty-dropdown": "All",
    "exposure-reduced": 19,
    "reduced-dif": null,
    "exposure-non-reduced": 81,
    "non-reduced-dif": null
};

var howardReducedPovertyData = {
    district: "Howard County",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 32,
    "reduced-dif": 13,
...
var howardNonReducedPovertyData = {
    district: "Howard County",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 16,
    "reduced-dif": -3,
    "exposure-non-reduced": 84,
    "non-reduced-dif": 3
};

var baltimoreAllPovertyData = {
    district: "Baltimore County",
    "poverty-dropdown": "All",
    "exposure-reduced": 47,
    "reduced-dif": null,
    "exposure-non-reduced": 53,
    "non-reduced-dif": null
};

var baltimoreReducedPovertyData = {
    district: "Baltimore County",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 59,
    "reduced-dif": 12,
    "exposure-non-reduced": 41,
    "non-reduced-dif": -12
};

var baltimoreNonReducedPovertyData = {
    district: "Baltimore County",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 37,
    "reduced-dif": -10,
    "exposure-non-reduced": 63,
    "non-reduced-dif": 10
};

var cityAllPovertyData = {
    district: "Baltimore City",
    "poverty-dropdown": "All",
    "exposure-reduced": 85,
    "reduced-dif": null,
    "exposure-non-reduced": 15,
    "non-reduced-dif": null
};

var cityReducedPovertyData = {
    district: "Baltimore City",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 87,
    "reduced-dif": 2,
    "exposure-non-reduced": 13,
    "non-reduced-dif": -2
};

var cityNonReducedPovertyData = {
    district: "Baltimore City",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 71,
    "reduced-dif": -14,
    "exposure-non-reduced": 29,
    "non-reduced-dif": 14
};

var aaAllPovertyData = {
    district: "Anne Arundel County",
    "poverty-dropdown": "All",
    "exposure-reduced": 32,
    "reduced-dif": null,
    "exposure-non-reduced": 68,
    "non-reduced-dif": null
};

var aaReducedPovertyData = {
    district: "Anne Arundel County",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 45,
    "reduced-dif": 13,
    "exposure-non-reduced": 55,
    "non-reduced-dif": -13
};

var aaNonReducedPovertyData = {
    district: "Anne Arundel County",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 26,
    "reduced-dif": -6,
    "exposure-non-reduced": 74,
    "non-reduced-dif": 6
};

var carrollAllPovertyData = {
    district: "Carroll County",
    "poverty-dropdown": "All",
    "exposure-reduced": 19,
    "reduced-dif": null,
...
var carrollNonReducedPovertyData = {
    district: "Carroll County",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 17,
    "reduced-dif": -2,
    "exposure-non-reduced": 83,
    "non-reduced-dif": 2
};

var harfordAllPovertyData = {
    district: "Harford County",
    "poverty-dropdown": "All",
    "exposure-reduced": 31,
    "reduced-dif": null,
    "exposure-non-reduced": 70,
    "non-reduced-dif": null
};

var harfordReducedPovertyData = {
    district: "Harford County",
    "poverty-dropdown": "Reduced",
    "exposure-reduced": 47,
    "reduced-dif": 16,
...
var harfordNonReducedPovertyData = {
    district: "Harford County",
    "poverty-dropdown": "Non-Reduced",
    "exposure-reduced": 23,
    "reduced-dif": -8,
    "exposure-non-reduced": 77,
    "non-reduced-dif": 7
};
...
window.onload = load_exposure_data(mdAllData);
...
var app = app || {
    ...
    share: function() {
        $(".icon-twitter").on("click", function() {
            var tweet = "A new wave of refugees, often from far-flung countries, are landing at Patterson High School. Read their stories: ";
            var url = "http://data.baltimoresun.com/news/unsettled-journeys/part-1/";
            var twitter_url = "https://twitter.com/intent/tweet?text=" + tweet + "&url=" + url + "&tw_p=tweetbutton";
            window.open(twitter_url, "mywin", "left=200,top=200,width=500,height=300,toolbar=1,resizable=0");
            return false;
        });
        $(".icon-facebook").on("click", function() {
            var picture = "http://data.baltimoresun.com/news/unsettled-journeys/part-1/images/topper.jpg";
            var title = "Unsettled Journeys: Torn between two worlds";
            var description = "A new wave of refugees, often from far-flung countries, are landing at Patterson High School. Read their stories.";
            var url = "http://data.baltimoresun.com/news/unsettled-journeys/part-1/";
...
!function(e, t) {
    ...
    return window.scrollReveal = function(e) {
        "use strict";
        function t(i) {
            return this instanceof t ? (r = this, r.elems = {}, r.serial = 1, r.blocked = !1, 
            r.config = o(r.defaults, i), r.isMobile() && !r.config.mobile || !r.isSupported() ? void r.destroy() : (r.config.viewport === e.document.documentElement ? (e.addEventListener("scroll", a, !1), 
            e.addEventListener("resize", a, !1)) : r.config.viewport.addEventListener("scroll", a, !1), 
            void r.init(!0))) : new t(i);
        }
        var i, o, a, r;
        return t.prototype = {
            defaults: {
            ...
            init: function(e) {
                ...
                o.forEach(function(e) {
                    t = r.serial++, i = r.elems[t] = {
                        domEl: e
                    }, i.config = r.configFactory(i), i.styles = r.styleFactory(i), i.seen = !1, e.removeAttribute("data-sr"), 
            ...
            animate: function(e) {
                ...
                var i, o, a;
                for (i in r.elems) r.elems.hasOwnProperty(i) && (o = r.elems[i], a = r.isElemInViewport(o), 
                a ? ("always" === r.config.delay || "onload" === r.config.delay && e || "once" === r.config.delay && !o.seen ? o.domEl.setAttribute("style", o.styles.inline + o.styles.target + o.styles.transition) : o.domEl.setAttribute("style", o.styles.inline + o.styles.target + o.styles.reset), 
                o.seen = !0, o.config.reset || o.animating || (o.animating = !0, t(i))) : !a && o.config.reset && o.domEl.setAttribute("style", o.styles.inline + o.styles.initial + o.styles.reset));
                r.blocked = !1;
            },
            configFactory: function(e) {
                ...
                }), i = o(i, r.config), i = o(i, t), "top" === i.enter || "bottom" === i.enter ? i.axis = "Y" : ("left" === i.enter || "right" === i.enter) && (i.axis = "X"), 
                ("top" === i.enter || "left" === i.enter) && (i.move = "-" + i.move), i;
            },
            styleFactory: function(e) {
                function t() {
                    0 !== parseInt(s.move) && (o += " translate" + s.axis + "(" + s.move + ")", r += " translate" + s.axis + "(0)"), 
                    0 !== parseInt(s.scale.power) && ("up" === s.scale.direction ? s.scale.value = 1 - .01 * parseFloat(s.scale.power) : "down" === s.scale.direction && (s.scale.value = 1 + .01 * parseFloat(s.scale.power)), 
                    o += " scale(" + s.scale.value + ")", r += " scale(1)"), s.rotate.x && (o += " rotateX(" + s.rotate.x + ")", 
                    r += " rotateX(0)"), s.rotate.y && (o += " rotateY(" + s.rotate.y + ")", r += " rotateY(0)"), 
                    s.rotate.z && (o += " rotateZ(" + s.rotate.z + ")", r += " rotateZ(0)"), o += "; opacity: " + s.opacity + "; ", 
                    r += "; opacity: 1; ";
                }
                ...
                o = "transform:", r = "transform:", t(), o += "-webkit-transform:", r += "-webkit-transform:", 
                t(), {
                    transition: n,
                    initial: o,
                    target: r,
